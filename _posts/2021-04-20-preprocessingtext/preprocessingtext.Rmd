...
> 단순히 한 문서 내 단어의 빈도수가 아니라 `해당 단어가 나타나는 문서들의 갯수도 고려`하여 특정 단어가 특정 문서내에서 얼마나 중요한지를 나타내는 통계적 수치를 단어 빈도-역 문서 빈도 (Term Frequency — Inverse Document Frequency, TF-IDF)라고 한다.
